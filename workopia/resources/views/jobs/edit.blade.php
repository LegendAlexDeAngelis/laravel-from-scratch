<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="salary" name="salary" label="Salary" type="number" placeholder="80000"
                :value="old('salary', $job->salary)" />

            <x-inputs.text-area id="requirements" name="requirements" label="Requirements"
                placeholder="Bachelor's degree in Computer Science" rows=3 :value="old('requirements', $job->requirements)" />
            ...
            <x-inputs.text id="county" name="county" label="County" placeholder="NY" :value="old('county', $job->county)" />
            ...
            <x-inputs.text-area id="company_description" name="company_description" label="Company Description"
                placeholder="Company Description" rows=3 :value="old('company_description', $job->company_description)" />
